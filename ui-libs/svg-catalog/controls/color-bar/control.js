(function (ActionAppCore, $) {
    ...
    var thisControlName = 'color-bar';
    var thisControlTitle = "Color Bar";
    var thisControlClass = 'ColorBar';
    ...
    function init(theParentSVG, theOptions) {
        ...
        var tmpPromise = this.initControl(theParentSVG, tmpOptions).then(
            function (theControl) {
                ...
                tmpThisControl.ctlColorBar = theControl.svgNode.select("#color-bar");
                tmpThisControl.ctlSelectedBar = theControl.svgNode.select("#selected-bar");
