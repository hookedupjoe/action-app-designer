'use strict';
const THIS_MODULE_NAME = 'update-cat-setup';
const THIS_MODULE_TITLE = 'Update catalog setup info and rebuild as needed';
...
module.exports.setup = function setup(scope) {
    ...
    base.run = function (req, res, next) {
        ...
        return bld.updateCatSetup(tmpAppName, tmpBody, scope)
